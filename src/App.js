...
import ConGC from './Stud Ass/ConGC';
import BackSu from './Stud Ass/BackSu/BackSu';
import BonC from './Stud Ass/BonC';
import DupGC from './Stud Ass/DupGC';
import EquC from './Stud Ass/EquC';
import TriToSem from './Stud Ass/TriToSem';
import MOI from './Stud Ass/MOI';
import NBC from './Stud Ass/NBC';
import OQ from './Stud Ass/OQ';
...
import StCertificate from './Stud Ass/Certificates/StCertificate';
...
function App() {
  return (
    ...
    <Router>
        ...
        <Route path="/home" element={<Home img1={Slide1} img2={Slide2} img3={Slide3} TT={"/timetable"} CONVO={"/convocation"} RESULT={'/result'}  Faq={"/faq"} whatsapp={"/"} certi={"/studentassistance"}/>} />

        <Route path="/Sthome" element={<Home img1={St1} img2={St2} img3={St3} TT={"/Sttimetable"} CONVO={"/Stconvocation"} RESULT={'/stresult'} Faq={"/faq"} whatsapp={"/whatsapp"} certi={"/ststudentassistance"}/>} />
        
        <Route path="/faq" element={<DyFaq />} />  
        ...
        <Route path="/studentassistance" element={<SA transcript={"/officialtranscript"} consolidate={"/consolidatedgradecard"} 
        baclogsummary={"/backlogsummary"} banafide={"/certificates"} euivalent={"/equivalentcertificate"} 
        tritosem={"/trimestertosemister"} moi={"/mediumofinstruction"} nobacklog={"/nobacklogcertificate"} 
        duplicateg={"/duplicategradecard"} duplicated={"/duplicatedegreecard"} other={"/otherquery"} />} />

        <Route path="/ststudentassistance" element={<SA transcript={"/officialtranscript"} consolidate={"/consolidatedgradecard"} 
        baclogsummary={"/backlogsummary"} banafide={"/stcertificate"} euivalent={"/equivalentcertificate"} 
        tritosem={"/trimestertosemister"} moi={"/mediumofinstruction"} nobacklog={"/nobacklogcertificate"} 
        duplicateg={"/duplicategradecard"} duplicated={"/duplicatedegreecard"} other={"/otherquery"} />} />
