            ...
            <div className="form-holder">
                <div className="form-content">
                    <div className="form-items">
                        <h3>CONSOLIDATED GRADE CARD from</h3>
                        ...
                        <form className="requires-validation" novalidate>
                            ...
                            <div className="col-md-12">
                                <input className="form-control" type="text" name="REQUIRED COPIES" placeholder="TRIMESTER NUMBER OF GRADE CARD" required/>
                                 <div className="valid-feedback">Trimester No field is valid!</div>
                                 <div className="invalid-feedback">Trimester cannot be blank!</div>
                            </div>
