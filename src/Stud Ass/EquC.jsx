                ...
                <div className="form-content">
                    <div className="form-items">
                        ...
                        <form className="requires-validation" novalidate>
                            ...
                            <div className="col-md-12">
                                <input className="form-control" type="text" name="REQUIRED COPIES" placeholder="YEAR OF PASSING" required/>
                           ...
                           <div className="col-md-12">
                                <input className="form-control" type="text" name="" placeholder="FINAL CGPA OR %" required/>
                                 <div className="valid-feedback">Email field is valid!</div>
                                 <div className="invalid-feedback">Email field cannot be blank!</div>
                            </div>

                            <div className="col-md-12">
                                <input className="form-control" type="text" name="" placeholder="REASONE" required/>
                                 <div className="valid-feedback">Email field is valid!</div>
                                 <div className="invalid-feedback">Email field cannot be blank!</div>
                            </div>
