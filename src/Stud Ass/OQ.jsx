                ...
                <div className="form-content">
                    <div className="form-items">
                        ...
                        <form className="requires-validation" novalidate>
                            ...
                            <div className="col-md-12">
                                <input className="form-control" type="TEXT" name="REQUIRED COPIES" placeholder=" PRESENT TRIMESTER NO OR PASSING MONTH AND YEAR" required/>
                           ...
                           <div className="col-md-12">
                                <input className="form-control" type="email" name="" placeholder="MENTION YOUR QUERY IN DETAIL" required/>
                                 <div className="valid-feedback">Query field is valid!</div>
                                 <div className="invalid-feedback">Query field cannot be blank!</div>
                            </div>
