...
<div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      ...
      <div className="carousel-caption d-none d-md-block mb-5" >
        <h1 className="poster">'ALL OF US DO NOT HAVE EQUAL TALENT. YET, ALL OF US HAVE AN EQUAL OPPORTUNITY TO DEVELOP OUR TALENTS.</h1>
        <h2>Ratan Tata</h2>
      </div>
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-none d-md-block mb-5">
        <h1 className="poster">'EVERBODY IS GENIUS. BUT IF YOU JUDGE A FISH ON ITS ABILITY TO CLIMB TREE, IT WILL LIVE ITS WHOLE LIFE BELIEVING ITS STUPITD.'</h1>
    ...
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-none d-md-block mb-5">
        <h1 className="poster">'WITHOUT YOUR INVOLVEMENT YOU CAN'T SUCCED. WITH YOUR INVOLVEMENT YOU CAN'T FAIL.'</h1>
  ...
  <img className="card-img-top" src={EO} alt="Card image cap" />
  ...
  <img className="card-img-top" src={SA} alt="Card image cap" />
  <h4 className="card-title" > STUDENT ASSISTANCE</h4>
  
  <p className="card-text">A platform for online application of educational documents.</p>
  <Link to={props.certi}><button type="button" className="btn btn-light btn-md">APPLY</button></Link>
</div></div>
  <div className="cArd"><div style={{backgroundColor:'#D885A3'}}>
  <img className="card-img-top" src={DA} alt="Card image cap"/>
  <h4 className="card-title">DIVYAGJAN SUPPORT</h4>
...
application portal.</p>
 <Link to="/divyangjan"> <button type="button" className="btn btn-light btn-md">APPLY</button></Link>
  ...
  <div className="cArd"><div style={{backgroundColor:'#97C26B'}}>
  <img className="card-img-top" src={DV} alt="Card image cap"/>
  <h4 className="card-title">THIRD PARTY DOCUMENT VERIFICATION</h4>
  
  <p className="card-text">The collection interface for students, organizations and companies to raise queries requesting verification of different kinds of data and documents from the university along with submitting the required fee for each request.</p>
 ...
 <div >
<div className="row" >
  <div className=" col-4 mt-5 text-center" style={{backgroundColor:'#A6CF98'}}>
    <img src={CONVO} className="card-img-top mt-5 " alt="" />
    <div className="card-body" style={{backgroundColor:'#A6CF98'}}>
    <Link to={props.CONVO}> <h2 className="card-title mt-5">CONVOVATION</h2></Link>
      
    </div>
  </div>
  <div className="col-4 mt-5 text-center " style={{backgroundColor:'#A6CF98'}}>
    <img src={TIMETABLE} className="imgT card-img-top mt-5  justify-content-center"  alt=""/>
    <div className="card-body" style={{backgroundColor:'#A6CF98'}}>
     <Link to={props.TT}> <h2 className="card-title mt-2">TIMETABLE</h2></Link>
      
    </div>
  </div>
  <div className="col-4 mt-5 text-center" style={{backgroundColor:'#A6CF98'}}>
    <img src={RESULT} className="imgR card-img-top mt-5  " alt=""/>
    <div className="card-body" style={{backgroundColor:'#A6CF98'}}>
    <Link to={props.RESULT}>  <h2 className="card-title mt-2">RESULT</h2></Link>
      ...
      <div className="our_solution_category">
        <div className="solution_cards_box">
          <div className="solution_card">
            ...
            <div className="solu_description">
              <p>
               I really liked the website the way it was built and the way it was presented.
              </p>
          ...
          <div className="solution_card">
            ...
            <div className="solu_title">
              <h3>Niranjan Korte</h3>
            </div>
            <div className="solu_description">
              <p>
              Great job by the authorities for making this website and making the administration smooth and saving time of students.
              </p>
              <button type="button" className="read_more_btn">Read More</button>
            </div>
          </div>
        ...
        <div className="solution_cards_box sol_card_top_3">
          <div className="solution_card">
            <div className="hover_color_bubble"></div>
            <div className="so_top_icon">
              <svg id="Layer_1" enable-background="new 0 0 512 512" height="60" viewBox="0 0 512 512" width="50" xmlns="http://www.w3.org/2000/svg">
                <g>
                  <g>
                    <g>
                      <g>
            ...
            <div className="solu_description">
              <p>
              A accountable website with smooth transparency and optimized solution.
              </p>
              <button type="button" className="read_more_btn">Read More</button>
            </div>
          </div>
          <div className="solution_card">
            ...
            <div className="solu_description">
              <p>
              I would like to thank Exam Department for helping me in the issue through the websie.
              </p>
            </div>
          </div>
        </div>
...
<div className="mt-5 pt-5 pb-5 ml-5 footer">
<div className="container">
  <div className="row">
    <div className="col-lg-5 col-xs-12 about-company">
      <h2> MIT WPU EXAM DEPARTMENT</h2>
      <p className="pr-5 text-white-50"> The unit duly constituted by the University to deal with all activities related to University Examinations. </p>
...
Saraswati A building, 7th floor, 
S. No. 124, Paud Road
Kothrud, Pune-411 038
Monday to Friday- 11.00 am to 5.00 pm
Saturday- 11.00 am to 1.00 pm</p>
      <p className="mb-0"><i className="fa fa-phone mr-3"></i>+91-8669990193/92</p>
      <p><i className="fa fa-envelope-o mr-3"></i>exam.helpdesk@mitwpu.edu.in</p>
    </div>
    ...
    <h3>TEAM</h3>
    <img enableBackground="new 0 0 512 512" height="60" viewBox="0 0 512 512" width="60" src={Aman}/>
    <h2>Aman Shaikh</h2>
    
    <img enableBackground="new 0 0 512 512" height="60" viewBox="0 0 512 512" width="60" src={Hitesh}/>

    <h2>Hitesh Dhavle</h2>
    <img enableBackground="new 0 0 512 512" height="60" viewBox="0 0 512 512" width="60" src={Sakshi}/>
  ...
  <div className="row mt-5">
    <div className="col copyright">
      <p className=""><small className="text-white-50">©2022.MITWPUEXAMDEPARTMENT.</small></p>
    </div>
  </div>
</div>
</div>
